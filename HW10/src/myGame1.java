...
public class myGame1 extends Applet implements ActionListener, MouseListener, MouseMotionListener {
	Button start;			
	thing theOne;
	newDude[] theOnes;
	TextField numBoxes, deadOrAlive, highScore;
	Timer timer;
	int a, b, z, j, t, c, x, p, v, hs, jared;
	Canvas c1;	
	Boolean[] startBool;
	Boolean checkBool=false, run=false;
	Graphics myG, thingG;
	Image gameOver;
			...
			public void run() {
				...
				while(x<=z){
					...
					if(checkBool){
						...
						z=0;t=0; a=0;  b=0; j=0; c=0; x=0; p=0; v=0; jared=0;
						timer.cancel();	
						checkBool=false;
...
class newDude{
	...
	public void move(int x1, int y1, int v){
